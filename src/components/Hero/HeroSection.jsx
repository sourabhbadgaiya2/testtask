import icon1 from "../../../public/assets/images/icons/image1.png";
import icon2 from "../../../public/assets/images/icons/image2.png";
import icon3 from "../../../public/assets/images/icons/image3.png";
import eye from "../../../public/assets/images/icons/eye.png";
import vol from "../../../public/assets/images/icons/vol.png";
import dot from "../../../public/assets/images/icons/dot.png";
...
import upwork from "../../../public/assets/images/trusted/upwork.png";
import "remixicon/fonts/remixicon.css";

const HeroSection = () => {
  return (
    <section className='bg-cover bg-center bg-[url(public/assets/images/Hero.png)] text-white p-8 md:p-16'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 sm:gap-10 md:gap-8'>
              ...
              <div className=' bg-red-50 rounded-xl p-4 sm:p-6 md:p-8'>
                ...
                <div className='flex flex-col gap-4 md:gap-12 mt-4 sm:mt-6 md:mt-8 relative'>
                  <img
                    src='public/assets/images/lines.png'
                    alt=''
