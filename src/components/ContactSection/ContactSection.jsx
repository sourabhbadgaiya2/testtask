...
const ContactSection = () => {
  ...
  if (isSmallScreen) {
    return (
      <div className='p-6 sm:p-0'>
        <div className='flex items-center rounded-[12vw] sm:rounded-none justify-center md:min-h-screen bg-[url(/assets/images/ContactBackground.png)] bg-no-repeat bg-cover bg-center px-4'>
  ...
  return (
    <section className="bg-[url('/assets/images/ContactBackground.png')] bg-no-repeat bg-cover bg-center py-12 px-4">
