    ...
    <section className='py-12 px-4 md:px-28'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
        <div className='bg-white p-6 rounded-lg shadow-lg'>
          <img
            src='src/assets/images/feature/project-management.png'
        ...
        <div className='bg-white p-6 rounded-lg shadow-lg'>
          <img
            src='src/assets/images/feature/workflows.jpg.png'
        ...
        <div className='bg-white p-6 rounded-lg shadow-lg'>
          <img
            src='src/assets/images/feature/goals.png'
        ...
        <div className='bg-white p-6 rounded-lg shadow-lg'>
          <img
            src='src/assets/images/feature/resource.png'
